...
const { autoScroll, clusterForm } = require("../../helpers/utils");
  ...
  try {
    ...
    const cluster = await Cluster.launch({
      ...
      puppeteerOptions: {
        ...
        timeout: 30000000, // Maximum time in milliseconds to wait for the browser instance to start. Defaults to 30000 (30 seconds). Pass 0 to disable timeout.
